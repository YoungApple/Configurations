...
alias api_server='java/com/google/ads/publisher/scripts/api/run-publisher-api
--adshost=yangshuguo.sha.corp.google.com --db=gfptest# --dbport=3307 --debug
--disableShardLookup=true --enableRequestScopedDplCaches=true --gfpTextLogFilterNoise=true --jpda_port=8184 --non_request_scoped_queries=GfpFeature.*,GfpFeatureGroup.*,GfpFeatureGroupFeature.*,GfpInventoryUnitType.*,GfpNetworkAttributeType.*,GfpNetworkAttributeValue.*,GfpNetworkFeatureGroup.*,GfpNetworkFeatureOverride.*,GfpUserInfo.*,GfpUserNetworkInMemoryRoleAssociation.*,User.*,UserPreferenceInternal.*,WebProperty.*
--password=adsgoogle --port=8181 --reporthost=yangshuguo.sha.corp.google.com
--soapOrStubbyApi=STUBBY_ONLY --txClearStateAfterEachTransaction=true'
...
alias g5lint_fix='/google/src/head/depot/google3/tools/java/remove_unused_imports.py -g --fix && buildifier -a -v'
alias g5sort='g5df | xargs sort_java_import'
alias g5e_all="git5 export --sq --tap-project=xfp_frontend,xfp_frontend.xsm,xfp.e2e --tap-options=email,detach"
alias g5e_rerun="git5 export --sq --tap-options=email,detach --tap-options=rerun=last --tap-project=xfp_frontend,xfp_frontend.xsm,xfp.e2e"

alias g5sync="git5 sync --tap-project=xfp-frontend --sync-at=green"
alias g5d='git5 diff'
alias g5df="git5 diff --name-only"
alias g5de='git5 diff --exported'
alias g5s_all='git5 submit --submit-queue --tap-project=xfp_frontend,xfp_frontend.xsm,xfp.e2e'
alias g5s_rerun='git5 submit --submit-queue --tap-options=rerun=last --tap-project=xfp_frontend,xfp_frontend.xsm,xfp.e2e'
